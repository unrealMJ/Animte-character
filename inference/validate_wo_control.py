...
if __name__ == '__main__':
    ...
    infer.build_pipe(os.path.join(exp_dir, f'checkpoint-{step}/pytorch_model.bin'))
    infer.make_hook()
    # prompt = 'best quality,high quality,1girl,upper body,closed eyes'
    # prompt = 'dog,white background,simple background'
    prompt = '1girl, closed eyes'

    reference_path = '/mnt/petrelfs/majie/project/My-IP-Adapter/data/test_demo/0.png'
    control_path = '/mnt/petrelfs/majie/project/My-IP-Adapter/data/test_demo/pose.png'
