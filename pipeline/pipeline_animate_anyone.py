...
class AnimateAnyonePipeline(DiffusionPipeline):
    ...
    def _encode_image(self, image, device, num_images_per_prompt, do_classifier_free_guidance):
        ...
        image_embeddings = self.image_encoder(image).pooler_output
    ...
    def __call__(
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                noise_pred = self.unet(latent_model_input, t, encoder_hidden_states=image_embeddings, latent_pose=pose_latents).sample
